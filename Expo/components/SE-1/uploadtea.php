...
foreach ($namedDataArray as $resx) {
 //Insert
 $result = $mysqli->query("SELECT Teacher_Id FROM teacher WHERE Teacher_Id = '".$resx['Teacher_Id']."' ");
    if($result->num_rows == 0)
    {
  $query = " INSERT INTO teacher (Teacher_Id,Teacher_Name,Teacher_Status) VALUES
      (
       '".$resx['Teacher_Id']."',
       '".$resx['Teacher_Name']."',
       '".$resx['Teacher_Status']."'
